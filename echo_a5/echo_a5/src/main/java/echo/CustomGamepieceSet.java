...
public class CustomGamepieceSet { //Utility class for consistent ordering by insertion

    LinkedHashMap<String,Gamepiece> pieces;
    ...
    public CustomGamepieceSet(int playerNo) {
        pieces = new LinkedHashMap<String,Gamepiece>();
        initialise(playerNo);
    }
